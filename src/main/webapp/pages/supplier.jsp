    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="myUpdateForm" class="form-horizontal">
                      ...
                      <input   name="isdelete" id="isdelete">
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <select  value="creditsituation" name="creditsituation">
        ...
        <form id="myaddForm" class="form-horizontal">
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <select  value="creditsituation" name="creditsituation">
					         <option  value="creditsituation">优秀</option>
					         <option  value="creditsituation">良好</option>
					         <option  value="creditsituation">差</option>
					      </select>
