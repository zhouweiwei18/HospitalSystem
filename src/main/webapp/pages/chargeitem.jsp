...
<script type="text/javascript">
  $(function(){
		    ...
		    title: '病人id'
			    ...
			    title: '检查费用'
				  ...
				  formatter:function(value,row,index){
					  var updateButton = "<button  onclick=\"myUpdateClick("+row.chargeid+")\" type=\"button\" class=\"btn btn-link\"><span class=\"glyphicon glyphicon-edit\" style=\"color: rgb(0, 0, 60); font-size: 17px;\"> </span></button>";
   ...
   /* 修改  预先查询病历信息显示于页面  */
function myUpdateClick(chargeid){
	  
	
	$.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/chargeitem/getById.action",//根据编号查询用户的信息
		 data:{chargeid:chargeid},//传参数到后台
		 ...
		 success:function(data){
			 //data：指后台查询后返回来的用户信息
			     $('#myUpdateModal').modal().on('shown.bs.modal',
			    	 ...
			    	 //给隐藏框赋值
			    	 $("#myUpdateChargeId").val(data.chargeid);
			    	 
			    	 $("#medicinefree1").val(data.medicinefree);
			    	 $("#checkfree1").val(data.checkfree);
...
//修改事件
  function updateChargeitem(){
  	...
  	$.ajax({
  		type:'post',//提交方式
  		url:'${pageContext.request.contextPath}/chargeitem/saveUpdateChargeitem.action',//修改的地址
  		data:data,
  		dataType:'json',
  		success:function(data){
  			if(data == 1){
		...
		function ClearInput() {
		  ...
		  function addChargeitem(){
			  ...
			  var data = $("#myAddForm").serializeArray();
			  	...
			  	$.ajax({
					type:'post',//提交方式
					url:'${pageContext.request.contextPath}/chargeitem/addChargeitem.action',//修改的地址
					data:data,
					dataType:'json',
					success:function(data){
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                  <form id="myAddForm" class="form-horizontal" action="">
					  ...
					  <div class="form-group">
					    ...
					    <div class="form-group">
					    <label class="col-sm-2 control-label">药费:</label>
					    <div class="col-sm-7">
					      <input type="text" class="form-control" name="medicinefree" id="medicinefree" placeholder="(必填项)">
					      <label id="medicinefree-error" class="error" for="medicinefree" style="margin-top: 4px;color: red;font-size: 15px;"></label>
					    </div>
					  </div>
					...
					<div class="form-group">
					    <label class="col-sm-2 control-label">检查费用:</label>
					    <div class="col-sm-7">
					      <input type="text" class="form-control" name="checkfree" id="checkfree" placeholder="(必填项)">
					      <label id="checkfree-error" class="error" for="checkfree" style="margin-top: 4px;color: red;font-size: 15px;"></label>
					    </div>
					  </div>
            ...
            <div class="modal-footer">
                ...
                <button onclick="addChargeitem()" type="button" class="btn btn-primary">添加</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <form id="myUpdateForm" class="form-horizontal">
                      <!-- 隐藏框传registerid的值 -->
                      <input type="hidden" name="chargeid" id="myUpdateChargeId">
				    ...
				    <div class="form-group">
					    <label class="col-sm-2 control-label">药费:</label>
					    <div class="col-sm-7">
					      <input type="text" class="form-control" name="medicinefree" id="medicinefree1" placeholder="(必填项)">
					      <label id="medicinefree1-error" class="error" for="medicinefree" style="margin-top: 4px;color: red;font-size: 15px;"></label>
					    </div>
					  </div>
					...
					<div class="form-group">
					    <label class="col-sm-2 control-label">检查费用:</label>
					    <div class="col-sm-7">
					      <input type="text" class="form-control" name="checkfree" id="checkfree1" placeholder="(必填项)">
					      <label id="checkfree1-error" class="error" for="checkfree" style="margin-top: 4px;color: red;font-size: 15px;"></label>
					    </div>
					  </div>
            ...
            <div class="modal-footer">
                ...
                <button onclick="updateChargeitem()" type="button" class="btn btn-primary">修改</button>
            </div>
        </div>
    </div>
</div>
