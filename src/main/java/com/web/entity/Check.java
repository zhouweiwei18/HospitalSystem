...
public class Check implements Serializable {
	...
	public boolean equals(Object that) {
		...
		return (this.getCheckid() == null ? other.getCheckid() == null : this.getCheckid().equals(other.getCheckid()))
				&& (this.getCheckdoctor() == null ? other.getCheckdoctor() == null
						: this.getCheckdoctor().equals(other.getCheckdoctor()))
				&& (this.getChecktime() == null ? other.getChecktime() == null
						: this.getChecktime().equals(other.getChecktime()))
				&& (this.getCheckprojectno() == null ? other.getCheckprojectno() == null
						: this.getCheckprojectno().equals(other.getCheckprojectno()))
				&& (this.getCheckresult() == null ? other.getCheckresult() == null
						: this.getCheckresult().equals(other.getCheckresult()))
				&& (this.getDoctoradviceid() == null ? other.getDoctoradviceid() == null
						: this.getDoctoradviceid().equals(other.getDoctoradviceid()))
