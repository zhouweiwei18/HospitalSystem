...
public class OutpatientCheck implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getOutpatientmedicalrecordid() == null ? other.getOutpatientmedicalrecordid() == null : this.getOutpatientmedicalrecordid().equals(other.getOutpatientmedicalrecordid()))
            && (this.getCheckdoctorid() == null ? other.getCheckdoctorid() == null : this.getCheckdoctorid().equals(other.getCheckdoctorid()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCheckdoctorid() == null) ? 0 : getCheckdoctorid().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", checkdoctorid=").append(checkdoctorid);
